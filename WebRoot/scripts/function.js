...
function myonclink(obj,bigClass){
	$(obj.parentNode).siblings().removeClass("current");
	$(obj.parentNode).addClass("current");
	$("#"+bigClass).addClass("displayblock");
	$("#"+bigClass).siblings().removeClass("displayblock");
	$("#"+bigClass).removeClass("displaynone");
	$("#"+bigClass).siblings().addClass("displaynone");
}
